...
export default class Banner extends Component {
    ...
    _animateBanner() {
        ...
        // //!TODO: line with 0 - top, setup order, kill() timeline, call tl, just one timeline, no const just this.ui..., call oncomplete function reveal (boolean), xy just numbers,
    ...
    _introAnimation() {
        ...
        this._tlIntro.from(this.ui.banner.current, { y: 50, onComplete: this._animateBanner() });
    }
}
